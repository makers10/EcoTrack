...
const carbon_module_1 = require("../carbon/carbon.module");
...
exports.ActivitiesModule = ActivitiesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: activities_schema_1.Activity.name, schema: activities_schema_1.ActivitySchema }]),
